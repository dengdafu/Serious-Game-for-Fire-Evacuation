...
public class PlayerDetailPanelConfirmButton : MonoBehaviour {
    ...
    public void OnClick()
    {
        ...
        // Set variables in Player.cs
        CurrentObject.GetComponent<Player>().FillInfo(name, xpos, ypos, speed, health);
